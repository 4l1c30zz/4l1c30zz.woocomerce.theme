...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<div class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
			<ul  class="thead">
				...
				<li class="product-thumbnail">&nbsp;</li>
				<li class="product-name"><?php esc_html_e( 'Product', 'woocommerce' ); ?></li>
				<li class="product-price"><?php esc_html_e( 'Price', 'woocommerce' ); ?></li>
				<li class="product-quantity"><?php esc_html_e( 'Quantity', 'woocommerce' ); ?></li>
